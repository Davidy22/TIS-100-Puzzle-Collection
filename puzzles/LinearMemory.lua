...
function get_description()
	return {
		"CREATE A 8-VALUE MEMORY UNIT",
		"A READ COMMAND IS STARTED WITH 1 FOLLOWED BY A INDEX FROM 1 TO 8",
		"A WRITE COMMAND IS STARTED WITH 2 FOLLOWED BY A INDEX A VALUE TO WRITE",
	}
end
